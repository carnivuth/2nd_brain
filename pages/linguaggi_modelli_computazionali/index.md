...
- [grammatiche di tipo 1](linguaggi_modelli_computazionali/GRAMMATICHE_TIPO_1.md)
- [grammatiche di tipo 2](linguaggi_modelli_computazionali/GRAMMATICHE_TIPO_2.md)
- [riconoscere grammatiche di tipo 2](linguaggi_modelli_computazionali/PDA.md)
- [aggiungere la semantica alle frasi](linguaggi_modelli_computazionali/INTERPRETI.md)
- [grammatiche llk](linguaggi_modelli_computazionali/GRAMMATICHE_LLK.md)
- [grammatiche lrk](linguaggi_modelli_computazionali/GRAMMATICHE_LRK.md)
- [grammatiche regolari](linguaggi_modelli_computazionali/GRAMMATICHE_REGOLARI.md)
- [un altra forma delle grammatiche regolari](linguaggi_modelli_computazionali/ESPRESSIONI_REGOLARI.md)
