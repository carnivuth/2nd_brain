...
Per poter applicare l'algoritmo [z-buffer](computer_graphics/real_time_rendering.md#algoritmo%20z-buffer) e necessario conoscere la **profondità di un pixel** all'interno del piano immagine una prima soluzione può essere:
...
[PREVIOUS](computer_graphics/algoritmi_rasterizzazione.md) [NEXT](computer_graphics/clipping.md)
