...
A seguito della [trasformazione di vista](computer_graphics/trasformazioni_vista.md) si rasterizza la faccia e per ogni pixel viene presa in considerazione la distanza Z, se questa e minore di quanto presente nello z buffer si disegna il pixel e si aggiorna lo z-buffer di conseguenza
...
[PREVIOUS](computer_graphics/trasformazioni_vista.md) [NEXT](computer_graphics/algoritmi_rasterizzazione.md)
